...
max_num = input('请设定最大范围: ')
secret = random.randint(1, int(max_num))  # generate 1-40 int

for a in range(0, 3):
    guess = int(input(f'pls keyin a number between 1-{max_num}: '))  #  input进来都是字符串
    if guess == secret:
        print('you are right')
        break
    elif guess > secret:
...
print('end of the game, the answer is :',secret)
